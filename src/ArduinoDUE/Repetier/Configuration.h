...
#define RETRACT_ON_PAUSE 13.0

#define COOLDOWN_ON_PAUSE 50    //  Amount of degrees to cool down the extruder on pausing
...
/*
 * Anteino 19-12-2017: This ensures the extruder that gets selected will be reset to its
 * old position. Comment if you want both extruders to use the same extrude position. This
...
#define FAN_THERMO_MAX_TEMP 55    //  Obsolete because we have a PID
...
#define FAN_THERMO_P  0.09
#define FAN_THERMO_I  0.01
