...
#define MAX_VFAT_ENTRIES (19)   //  I understand vfat supports filenames up to 255 characters. The variable in which the filename is stored has length 2 * MAX_VFAT_ENTRIES + 1 + 1. So 19 is the closest but not bigger than 255.
...
#define PWM_CASE_FAN PWM_FAN2 + 1
#define PWM_FAN_THERMO PWM_CASE_FAN+1
...
public:
    ...
    void saveStopPrint(bool keepHeat);
