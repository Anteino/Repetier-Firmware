...
/*
  ...
  %an : Active knob in bed leveling, there is the left and the right knob
  ...
  %en : trivial extruder name; "left" and "right"
...
UI_MENU_ACTIONCOMMAND(ui_menu_setlang_nl, "Nederlands", UI_ACTION_LANGUAGE_NL | UI_ACTION_TOPMENU)
#if FIRSTLANG
...
#define UI_MENU_LANGUAGES {UI_MENU_ADDCONDBACK ADD_LANG_EN ADD_LANG_DE ADD_LANG_NL}
...
#define UI_MENU_LANGUAGES_WIZ {ADD_LANG_EN ADD_LANG_DE ADD_LANG_NL}
...
UI_MENU(ui_menu_languages, UI_MENU_LANGUAGES, UI_MENU_BACKCNT + LANGUAGE_EN_ACTIVE + LANGUAGE_DE_ACTIVE + LANGUAGE_NL_ACTIVE)
...
UI_STICKYMENU(ui_menu_languages_wiz, UI_MENU_LANGUAGES_WIZ, LANGUAGE_EN_ACTIVE + LANGUAGE_DE_ACTIVE + LANGUAGE_NL_ACTIVE)
...
// Bed leveling wizard
UI_BED_WIZARD_T(ui_wiz_bed_level, UI_ACTION_WIZARD_BED_LEVEL, UI_TEXT_WIZ_BED_LEVEL1_ID, UI_TEXT_WIZ_BED_LEVEL2_ID, UI_TEXT_WIZ_BED_LEVEL3_ID, UI_TEXT_WIZ_BED_LEVEL4_ID) // start wizard, extruder 0, level point 1
UI_BED_WIZARD_T(ui_wiz_manual_probe, UI_ACTION_WIZARD_BED_LEVEL, UI_TEXT_WIZ_MANUAL_PROBE1_ID, UI_TEXT_WIZ_MANUAL_PROBE2_ID, UI_TEXT_WIZ_MANUAL_PROBE3_ID, UI_TEXT_WIZ_MANUAL_PROBE4_ID) // move Z with display knob
UI_BED_WIZARD_T(ui_wiz_hardware_knob_left, UI_ACTION_WIZARD_BED_LEVEL, UI_TEXT_WIZ_HARDWARE_KNOB_LEFT1_ID, UI_TEXT_WIZ_HARDWARE_KNOB_LEFT2_ID, UI_TEXT_WIZ_HARDWARE_KNOB_LEFT3_ID, UI_TEXT_WIZ_HARDWARE_KNOB_LEFT4_ID) // left bed knob
UI_BED_WIZARD_T(ui_wiz_hardware_knob_right, UI_ACTION_WIZARD_BED_LEVEL, UI_TEXT_WIZ_HARDWARE_KNOB_RIGHT1_ID, UI_TEXT_WIZ_HARDWARE_KNOB_RIGHT2_ID, UI_TEXT_WIZ_HARDWARE_KNOB_RIGHT3_ID, UI_TEXT_WIZ_HARDWARE_KNOB_RIGHT4_ID) // right bed knob
//  End of wizard

//  Leveling and nozzle calibration wizard
UI_LEVEL_OFFSET_T(ui_level_offset_heatup, UI_ACTION_LEVEL_OFFSET, UI_TEXT_LEVEL_OFFSET_HEATUP_1_ID, UI_TEXT_LEVEL_OFFSET_HEATUP_2_ID, UI_TEXT_LEVEL_OFFSET_HEATUP_3_ID, UI_TEXT_LEVEL_OFFSET_HEATUP_4_ID)
UI_LEVEL_OFFSET_T(ui_level_offset_turn_knobs_1, UI_ACTION_LEVEL_OFFSET, UI_TEXT_LEVEL_OFFSET_TURN_KNOBS_1_1_ID, UI_TEXT_LEVEL_OFFSET_TURN_KNOBS_1_2_ID, UI_TEXT_LEVEL_OFFSET_TURN_KNOBS_1_3_ID, UI_TEXT_LEVEL_OFFSET_TURN_KNOBS_1_4_ID)
UI_LEVEL_OFFSET_T(ui_level_offset_await_instructions, UI_ACTION_LEVEL_OFFSET, UI_TEXT_AWAIT_INSTRUCTIONS_1_ID, UI_TEXT_AWAIT_INSTRUCTIONS_2_ID, UI_TEXT_AWAIT_INSTRUCTIONS_3_ID, UI_TEXT_AWAIT_INSTRUCTIONS_4_ID)
UI_LEVEL_OFFSET_T(ui_level_offset_turn_knobs_2, UI_ACTION_LEVEL_OFFSET, UI_TEXT_LEVEL_OFFSET_TURN_KNOBS_2_1_ID, UI_TEXT_LEVEL_OFFSET_TURN_KNOBS_2_2_ID, UI_TEXT_LEVEL_OFFSET_TURN_KNOBS_2_3_ID, UI_TEXT_LEVEL_OFFSET_TURN_KNOBS_2_4_ID)
//UI_LEVEL_OFFSET_T(ui_level_offset_turn_error, UI_ACTION_LEVEL_OFFSET, UI_TEXT_LEVEL_OFFSET_TURN_ERROR_1_ID, UI_TEXT_LEVEL_OFFSET_TURN_ERROR_2_ID, UI_TEXT_LEVEL_OFFSET_TURN_ERROR_3_ID, UI_TEXT_LEVEL_OFFSET_TURN_ERROR_4_ID)
UI_LEVEL_OFFSET_T(ui_level_offset_nozzle, UI_ACTION_LEVEL_OFFSET, UI_TEXT_LEVEL_OFFSET_NOZZLE_1_ID, UI_TEXT_LEVEL_OFFSET_NOZZLE_2_ID, UI_TEXT_LEVEL_OFFSET_NOZZLE_3_ID, UI_TEXT_LEVEL_OFFSET_NOZZLE_4_ID)
UI_LEVEL_OFFSET_T(ui_level_offset_rerun, UI_ACTION_LEVEL_OFFSET, UI_TEXT_LEVEL_OFFSET_RERUN_1_ID, UI_TEXT_LEVEL_OFFSET_RERUN_2_ID, UI_TEXT_LEVEL_OFFSET_RERUN_3_ID, UI_TEXT_LEVEL_OFFSET_RERUN_4_ID)
//  End of wizward

//  Filament change wizard
UI_FILACHANGE_T(ui_filachange_choose_ext, UI_ACTION_FILACHANGE, UI_TEXT_FILACHANGE_CHOOSE_EXT_1_ID, UI_TEXT_FILACHANGE_CHOOSE_EXT_2_ID, UI_TEXT_FILACHANGE_CHOOSE_EXT_3_ID, UI_TEXT_FILACHANGE_CHOOSE_EXT_4_ID)
UI_FILACHANGE_T(ui_filachange_await_instructions, UI_ACTION_FILACHANGE, UI_TEXT_AWAIT_INSTRUCTIONS_1_ID, UI_TEXT_AWAIT_INSTRUCTIONS_2_ID, UI_TEXT_AWAIT_INSTRUCTIONS_3_ID, UI_TEXT_AWAIT_INSTRUCTIONS_4_ID)
UI_FILACHANGE_T(ui_filachange_old_temp, UI_ACTION_FILACHANGE, UI_TEXT_FILACHANGE_OLD_TEMP_1_ID, UI_TEXT_FILACHANGE_OLD_TEMP_2_ID, UI_TEXT_FILACHANGE_OLD_TEMP_3_ID, UI_TEXT_FILACHANGE_OLD_TEMP_4_ID)
UI_FILACHANGE_T(ui_filachange_new_temp, UI_ACTION_FILACHANGE, UI_TEXT_FILACHANGE_NEW_TEMP_1_ID, UI_TEXT_FILACHANGE_NEW_TEMP_2_ID, UI_TEXT_FILACHANGE_NEW_TEMP_3_ID, UI_TEXT_FILACHANGE_NEW_TEMP_4_ID)
UI_FILACHANGE_T(ui_filachange_change, UI_ACTION_FILACHANGE, UI_TEXT_FILACHANGE_CHANGE_1_ID, UI_TEXT_FILACHANGE_CHANGE_2_ID, UI_TEXT_FILACHANGE_CHANGE_3_ID, UI_TEXT_FILACHANGE_CHANGE_4_ID)
UI_FILACHANGE_T(ui_filachange_finish, UI_ACTION_FILACHANGE, UI_TEXT_FILACHANGE_FINISH_1_ID, UI_TEXT_FILACHANGE_FINISH_2_ID, UI_TEXT_FILACHANGE_FINISH_3_ID, UI_TEXT_FILACHANGE_FINISH_4_ID)
//  End of wizard

//  Extruder XY offset calibration wizard
//UI_XY_OFFSET_T(ui_xyoffset_filaload, UI_ACTION_XY_OFFSET, UI_TEXT_XY_OFFSET_FILALOAD_1_ID, UI_TEXT_XY_OFFSET_FILALOAD_2_ID, UI_TEXT_XY_OFFSET_FILALOAD_3_ID, UI_TEXT_XY_OFFSET_FILALOAD_4_ID)
//UI_XY_OFFSET_T(ui_xyoffset_request_filachange, UI_ACTION_XY_OFFSET, UI_TEXT_XY_OFFSET_REQUEST_FILACHANGE_1_ID, UI_TEXT_XY_OFFSET_REQUEST_FILACHANGE_2_ID, UI_TEXT_XY_OFFSET_REQUEST_FILACHANGE_3_ID, UI_TEXT_XY_OFFSET_REQUEST_FILACHANGE_4_ID)
//UI_XY_OFFSET_T(ui_xyoffset_wait_temp, UI_ACTION_XY_OFFSET, UI_TEXT_XY_OFFSET_WAIT_TEMP_1_ID, UI_TEXT_XY_OFFSET_WAIT_TEMP_2_ID, UI_TEXT_XY_OFFSET_WAIT_TEMP_3_ID, UI_TEXT_XY_OFFSET_WAIT_TEMP_4_ID)
//UI_XY_OFFSET_T(ui_xyoffset_wait_print, UI_ACTION_XY_OFFSET, UI_TEXT_XY_OFFSET_WAIT_PRINT_1_ID, UI_TEXT_XY_OFFSET_WAIT_PRINT_2_ID, UI_TEXT_XY_OFFSET_WAIT_PRINT_3_ID, UI_TEXT_XY_OFFSET_WAIT_PRINT_4_ID)
//UI_XY_OFFSET_T(ui_xyoffset_measure, UI_ACTION_XY_OFFSET, UI_TEXT_XY_OFFSET_MEASURE_1_ID, UI_TEXT_XY_OFFSET_MEASURE_2_ID, UI_TEXT_XY_OFFSET_MEASURE_3_ID, UI_TEXT_XY_OFFSET_MEASURE_4_ID)
//UI_XY_OFFSET_T(ui_xyoffset_finish, UI_ACTION_XY_OFFSET, UI_TEXT_XY_OFFSET_FINISH_1_ID, UI_TEXT_XY_OFFSET_FINISH_2_ID, UI_TEXT_XY_OFFSET_FINISH_3_ID, UI_TEXT_XY_OFFSET_FINISH_4_ID)
//  End of extruder XY offset calibration wizard
...
#endif
#if FEATURE_RETRACTION
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_filachange, UI_TEXT_FILACHANGE_ID, UI_ACTION_FILACHANGE)
#define UI_FILACHANGE_CNT 1
#define UI_FILACHANGE_ENT ,&ui_menu_quick_filachange
#else
...
UI_MENU_HEADLINE_T(ui_menu_sd_askstop_keep_heat_head, UI_TEXT_STOP_PRINT_ID)
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_sd_askstop_keep_heat_yes,      UI_TEXT_YES_ID,     UI_ACTION_SD_STOP_KEEP_HEAT | UI_ACTION_TOPMENU,     MENU_MODE_SD_PRINTING, 0)
...
UI_MENU_ACTIONCOMMAND_T(ui_menu_config_bed_level, UI_TEXT_BED_LEVEL_ID, UI_ACTION_WIZARD_BED_LEVEL)
#define UI_BED_LEVEL_COUNT 1
#define UI_BED_LEVEL_ENT &ui_menu_config_bed_level,

UI_MENU_ACTIONCOMMAND_T(ui_menu_config_level_offset, UI_TEXT_LEVEL_OFFSET_ID, UI_ACTION_LEVEL_OFFSET)
#define UI_LEVEL_OFFSET_COUNT 1
#define UI_LEVEL_OFFSET_ENT , &ui_menu_config_level_offset,

//UI_MENU_ACTIONCOMMAND_T(ui_menu_config_xyoffset, UI_TEXT_XY_OFFSET_ID, UI_ACTION_XY_OFFSET)
//#define UI_XY_OFFSET_COUNT 1
//#define UI_XY_OFFSET_ENT &ui_menu_config_xyoffset, 
...
#endif
#define UI_MENU_CONFIGURATION {UI_MENU_ADDCONDBACK &ui_menu_conf_general LANGMENU_ENTRY ,&ui_menu_conf_accel UI_LEVEL_OFFSET_ENT UI_BED_LEVEL_ENT &ui_menu_conf_feed,&ui_menu_conf_extr UI_MENU_BEDCONF_COND UI_MENU_EEPROM_COND UI_MENU_DELTA_COND UI_MENU_SL_COND}
UI_MENU(ui_menu_configuration, UI_MENU_CONFIGURATION, UI_MENU_BACKCNT + LANGMENU_COUNT + UI_BED_LEVEL_COUNT + UI_LEVEL_OFFSET_COUNT + UI_MENU_EEPROM_CNT + UI_MENU_BEDCONF_CNT + UI_MENU_DELTA_CNT + UI_MENU_SL_CNT + 4)
